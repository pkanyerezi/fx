...
<form class="form-search form-inline">
     <input type="text" placeholder="search clients..." class="search-query tip-right site-search-users" style="width:30%" />
</form>
	
</div>
<style>
	<!--
		#search-site{position: absolute;z-index: 10000;top: 35px;width: 40%;}
		#search-site input[type=text]{background-color: #f1f2f3;}
		.search-results{min-height: 176px;max-height: 400px;width: 20%;top: 45px;position: absolute;z-index: 10000;border-radius: 5px;opacity: 0.98;overflow-y:auto;overflow-x:auto;color:#000;}
