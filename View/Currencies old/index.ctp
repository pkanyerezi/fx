...
<div class="currencies index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Delete'), array('action' => 'delete', $currency['Currency']['id']),array('class'=>'action-delete confirm-first','data-confirm-text'=>'Are you sure you want to delete it?')); ?>
			<?php endif;?>
		</td>
	</tr>
<?php endforeach; ?>
