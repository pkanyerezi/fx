...
<div class="soldReceipts printable well well-new">
	...
	<div class="my_data">
		...
		<tr style="border-left:4px solid #F9F9F9;border-right:4px solid #F9F9F9;">
			...
			<td><?php echo h($soldReceipt['SoldReceipt']['id']); ?>&nbsp;</td>
			...
			<td>
				...
				<?php else: ?>
					...
					<?php echo $soldReceipt['Currency']['id']; ?>
				<?php endif; ?>
				&nbsp;		
				</a>
			</td>
			<td><?php echo h($soldReceipt['SoldReceipt']['instrument']); ?>&nbsp;</td>
			<td class="non_printable"><?php echo h($soldReceipt['SoldReceipt']['customer_name']); ?>&nbsp;</td>
	...
	<?php endforeach; ?>
		...
		<tr  style="background:#2c2c2c;color:#fff;">
			...
			<td colspan="1"><span>AVG-RATE:<?php echo ($total_foreign!=0)?round($total_ugx/$total_foreign,2):0; ?></span></td>
			<td colspan="1"><span>AVG-RATE:<?php echo ($total_count!=0)?round($total_rate/$total_count,2):0; ?></span></td>
		</tr>
		<?php else:?>
		<tr  style="background:#2c2c2c;color:#fff;">
