...
<div id="<?php echo $data['id']; ?>" class="notification-item <?php echo $data['is_read']; ?> btn btn-inverse" style="width:85%;text-align:left;">
	<?php echo $this->Html->link('x', array('plugin' => 'notifications', 'controller' => 'notifications', 'action' => 'read', $data['id']), array('class' => 'use-ajax-notifs-ReadOnly')); ?>
        <div>
