...
<head>
	...
	<style>
		#new-receipts{font-size:15px !important;}
...
<body>
<br/><br/><br/>
	<div id="new-receipts" style="font-size:15px;">
		...
		<div style="font-size:12px;" >
			...
			<br/><br/>To be completed for transactions of US$5,000= and above or its equivalent
